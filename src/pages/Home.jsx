        ...
        <div>
            ...
            <div className=" mx-auto mt-36">
                <div className="md:flex w-11/12 mx-auto md:w-full">
                    <div className="md:w-1/2 md:ml-10">
                        ...
                        <h1 className='text-4xl md:text-5xl font-semibold'>Ways to help</h1>
                        <h1 className='text-xl font-bold text-red-600'>___________</h1>
                        <p className='my-10 text-xl'>Blood Center is public donation center with blood donation members in the changing health care system. Founded in 1978, Blood Center is one of the nation’s oldest and largest nonprofit transfusion medicine organizations. We provide a blood and volunteer services across the US. With our national footprint, deep community roots and specialized services, we are the thread that connects people and resources together to fuel progress in transfusion medicine.</p>
                    ...
                    <div className="md:w-1/2 mt-6 md:mt-0">
                        <img src="https://i.ibb.co/z2dTKRx/pexels-evg-kowalievska-1170979.jpg" alt="" />
                    </div>
                </div>
            </div>

            {/*  */}
            <div className="w-11/12 mx-auto mt-36 grid grid-cols-1 md:grid-cols-3 gap-7">
                <div className="card bg-slate-400 hover:scale-105 transition-all">
                    <div className="card-body">
                        <h2 className="text-3xl font-semibold text-white">Donation Location</h2>
                        <div className="card-actions justify-end mt-20">
                            <button className=' bg-white hover:bg-red-600 btn border-0 rounded-sm hover:text-white'>Learn More</button>
                        </div>
                    </div>
                </div>
                <div className="card bg-slate-500 hover:scale-105 transition-all">
                    <div className="card-body">
                        <h2 className="text-3xl font-semibold text-white">Eligibility Requirements</h2>
                        <div className="card-actions justify-end mt-20">
                            <button className=' bg-white hover:bg-red-600 btn border-0 rounded-sm hover:text-white'>Learn More</button>
                        </div>
                    </div>
                </div>
                <div className="card bg-slate-600 hover:scale-105 transition-all">
                    <div className="card-body">
                        <h2 className="text-3xl font-semibold text-white">The Donation Process</h2>
                        <div className="card-actions justify-end mt-20">
                            <button className=' bg-white hover:bg-red-600 btn border-0 rounded-sm hover:text-white'>Learn More</button>
                        </div>
                    </div>
            ...
            <div className="mt-36">
                <div className="md:flex w-full gap-20">
                    <div className="md:w-1/2">
                        <img src="https://i.ibb.co/7k5X8f3/pexels-charliehelen-robinson-4531306.jpg" alt="" />
                    </div>
                    <div className="md:w-1/2 md:mr-20 mx-5 md:mx-0">
                        <h1 className='text-4xl mt-10 md:mt-0 md:text-5xl font-semibold'>World Blood Donors <br /> Day</h1>
                        <p className='mt-5 text-xl'>Every year, on 14 June, countries around the world celebrate World Blood Donor Day. The event serves to raise awareness of the need for safe blood and blood products and to thank blood donors for their life-saving gifts of blood.</p>
